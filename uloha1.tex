...
kde $\mathcal{L}_{i}$ je trieda všetkých jazykov typu $i$. Podľa Chomského definícií gramatík v kapitole 2.3 v študíjnej
...
Jazyk $L_{1}$ teda môže byť typu 2 či 3. Je teda potrebné dokázať, o aký jazyk sa jedná pomocou pumping lemma pre
